/* tslint:disable */
/* eslint-disable */
export function verify_proof(proof_bytes: Uint8Array, image_id_bytes: Uint8Array): void;

export type InitInput = RequestInfo | URL | Response | BufferSource | WebAssembly.Module;

export interface InitOutput {
  readonly memory: WebAssembly.Memory;
  readonly verify_proof: (a: number, b: number, c: number, d: number) => [number, number];
